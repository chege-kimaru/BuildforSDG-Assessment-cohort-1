...
const normalizeTime = (data) => {
  switch (data.periodType) {
    ...
    default:
      throw new Error('Unrecognized period type. Supported types are days, weeks and months.');
  }
};
...
// challenge 2
const severeCasesByRequestedTime = (data, severe) => Math.trunc(0.15
...
// challenge 3
const casesForICUByRequestedTime = (data, severe) => Math.trunc(0.05
  * infectionsByRequestedTime(data, severe));
